...
function _createFieldsMapper(fields) {
  if (!fields || isArray(fields) && !fields.length || !isArray(fields) && !getKeys(fields).length)
  ...
  }, /* @__PURE__ */ Object.create(null)) : fields;
  return function(item) {
    if (isArray(item)) {
...
function _createTableMap(data) {
  return data.map(getEntries).reduce(function(tMap, rowKVs, rowIndex) {
    return rowKVs.reduce(function(map, _a) {
      var _b = __read(_a, 2), key = _b[0], value = _b[1];
      var columnValues = map[key] || Array.from({ length: data.length }).map(function(_) {
        return "";
      });
...
var defaultCreateCSVDataOption = { beforeTableEncode: function(i) {
  return i;
}, delimiter: "," };
function createCSVData(data, options) {
  ...
  var head = tableEntries.map(function(_a2) {
    var fieldName = _a2.fieldName;
    return fieldName;
  }).join(delimiter) + "\r\n";
  var columns = tableEntries.map(function(_a2) {
    var fieldValues = _a2.fieldValues;
    return fieldValues;
  }).map(function(column) {
...
var defaultCreateXLSDataOptions = { beforeTableEncode: function(i) {
  return i;
} };
...
function exportFromJSON(_a) {
  var data = _a.data, _b = _a.fileName, fileName = _b === void 0 ? "download" : _b, extension = _a.extension, _c = _a.fileNameFormatter, fileNameFormatter = _c === void 0 ? function(name) {
    return name.replace(/\s+/, "_");
  } : _c, fields = _a.fields, _d = _a.exportType, exportType = _d === void 0 ? "txt" : _d, _e = _a.replacer, replacer = _e === void 0 ? null : _e, _f = _a.space, space = _f === void 0 ? 4 : _f, _g = _a.processor, processor = _g === void 0 ? downloadFile : _g, _h = _a.withBOM, withBOM = _h === void 0 ? false : _h, _j = _a.beforeTableEncode, beforeTableEncode = _j === void 0 ? function(i) {
    return i;
  } : _j, _k = _a.delimiter, delimiter = _k === void 0 ? "," : _k;
  ...
  switch (exportType) {
    ...
    case "csv": {
      ...
      var BOM = "\uFEFF";
      var CSVData = createCSVData(safeData, { beforeTableEncode, delimiter });
...
var exportFromJSON_default = exportFromJSON;

// node_modules/export-from-json/dist/esm/index.js
var esm_default = exportFromJSON_default;
export {
  esm_default as default
};
//# sourceMappingURL=export-from-json.js.map
